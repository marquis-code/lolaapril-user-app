    ...
    <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
      ...
      <div class="space-y-4 text-primary/80 leading-relaxed">
        <p>
          ...
          an entrepreneurial venture crafting hand-made shoes, earning her the prestigious YouWin! Award. 
          Her dedication shone as she simultaneously completed her Law degree.
        </p>
        <p>
          In 2019, seeking new horizons, Lola formalised her commitment to exceptional service by 
          obtaining certification from The Beauty Therapy Institute. Thus, Lola April Wellness Spa 
          was born—a haven where relaxation, beauty, and wellness converge.
        </p>
        <p>
          Lola introduced the groundbreaking concept of Spa BnB—an idea born from the belief that 
          everyone deserves a personal retreat without breaking the bank. to ensure complete wellness 
          is available to everyone who desires it. Imagine being able to visit the spa and extend your 
          experience by sleeping over, ensuring you leave feeling truly pampered.
        </p>
      </div>
    </div>
  </section>
