          ...
          <div class="h-full overflow-y-auto custom-scrollbar">
            ...
            <div class="relative bg-gradient-to-br from-[#005967] via-[#006a7a] to-[#005967] text-white px-4 sm:px-6 py-8 sm:py-12 text-center overflow-hidden">
              <div class="relative z-20 max-w-2xl mx-auto">
                ...
                <NuxtLink to="/book?subdomain=benn" class="group text-xs sm:text-sm bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white font-bold px-6 sm:px-8 py-2.5 sm:py-3 rounded-full shadow-2xl transition-all hover:scale-105 inline-flex items-center gap-2">
            ...
            <div class="bg-gradient-to-br from-[#005967] to-[#006a7a] text-white px-4 sm:px-6 py-8 sm:py-12 text-center">
              <div class="max-w-2xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-3 justify-center">
                  <NuxtLink to="/book?subdomain=benn" class="bg-pink-500 hover:bg-pink-600 text-sm sm:text-base text-white font-bold px-6 sm:px-8 py-3 rounded-full transition-all hover:scale-105 shadow-xl">
                    Book Online
                  </NuxtLink>
                </div>
