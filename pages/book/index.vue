  ...
  <div class="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4">
    ...
    <div v-else-if="business" class="max-w-md w-full bg-white rounded-xl shadow-lg overflow-hidden">
      ...
      <div class="pt-14 pb-8 px-6 text-center">
        ...
        <p class="text-gray-600 mb-6">{{ business.businessDescription || 'Welcome to our booking page.' }}</p>

        <div class="space-y-4">
          <button 
            @click="startBooking"
            class="w-full bg-primary hover:bg-pink-600 text-white font-bold py-3 px-6 rounded-lg transition duration-200 shadow-md transform hover:scale-105"
          >
            Book Appointment
          </button>
